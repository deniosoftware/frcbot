    ...
    blocks: [
      ...
      },
      {
        ...
        hint: {
          type: "plain_text",
          text:
            "Notifications may not arrive on time. FRCBot requires the event's FMS and The Blue Alliance to be online. Please don't depend on FRCBot to tell you when you are queued for a match.",
        },
      ...
      },
      {
        ...
        hint: {
          type: "plain_text",
          text:
            "A comma-seperated list of additional teams you'd like to subscribe to.",
        },
        ...
        element: {
          ...
          initial_value: data.additional_teams
            ? JSON.parse(data.additional_teams).join(", ")
            : "",
          placeholder: {
            type: "plain_text",
