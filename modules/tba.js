...
tbaClient.prototype.getTeam = function (teamNumber) {
  return new Promise((resolve, reject) => {
    request(
      `https://www.thebluealliance.com/api/v3/team/frc${teamNumber.toString()}`,
      {
        headers: {
...
tbaClient.prototype.getAvatar = function (teamNumber) {
  return new Promise((resolve, reject) => {
    request(
      `https://www.thebluealliance.com/api/v3/team/frc${teamNumber.toString()}/media/${new Date()
        .getFullYear()
        .toString()}`,
      {
        headers: {
...
tbaClient.prototype.getTeamEvents = function (team, year) {
  return new Promise((resolve, reject) => {
    request(
      `https://www.thebluealliance.com/api/v3/team/frc${team}/events/${year.toString()}`,
      {
        headers: {
          "X-TBA-Auth-Key": this.token,
        },
...
tbaClient.prototype.getEventSchedule = function (event_code) {
  return new Promise((resolve, reject) => {
    request(
      `https://www.thebluealliance.com/api/v3/event/${event_code}/matches`,
      {
        headers: {
          "X-TBA-Auth-Key": this.token,
        },
...
tbaClient.prototype.getRankings = function (event_code) {
  return new Promise((resolve, reject) => {
    request(
      `https://www.thebluealliance.com/api/v3/event/${event_code}/rankings`,
      {
        headers: {
          "X-TBA-Auth-Key": this.token,
        },
